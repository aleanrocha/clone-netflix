...
export const Home = () => {
  return (
    <Fragment>
      <Header />
      <Banner />
      <div className="bg-box-radial-mobile-flix md:bg-box-radial-desktop-flix w-11/12 md:w-4/5 mx-auto mt-4 p-6 pt-16 md:pt-6 rounded-md flex flex-col md:flex-row gap-2 md:gap-8 md:justify-center md:-mt-[72px] relative">
        <PopcornIcon />
